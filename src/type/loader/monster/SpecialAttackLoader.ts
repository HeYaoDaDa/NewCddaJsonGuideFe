...
export class SpecialAttack extends SuperLoader<SpecialAttackInterface> {
  doLoad(data: SpecialAttackInterface, jsonItem: JsonItem): void {
  ...
  private parseJson(data: SpecialAttackInterface, jsonObject: Record<string, unknown>, jsonItem: JsonItem) {
...
interface SpecialAttackInterface {
  name: string;
  description: string;
  symbol: string;
  color: string;
